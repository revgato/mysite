...
class BookInstance(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, help_text=_("Unique ID for this particular book accross whole library"))
    ...
    status = models.CharField(
        ...
        blank=True,
        default='m',
        help_text=_("Book availablitity")
    )
